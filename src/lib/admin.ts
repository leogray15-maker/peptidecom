...
export const ACTION_LABEL: Record<string, string> = {
  ...
  "story.approved": "Marked a story ready to post",
  "story.posted": "Marked a story posted",
  "story.skipped": "Skipped a story",
  "story.new": "Reopened a story",
  "story.featured": "Put a story on the public site",
  "story.unfeatured": "Took a story off the public site",
  "proof.created": "Added a proof entry",
  "proof.updated": "Edited a proof entry",
  "proof.published": "Put proof on the public site",
  "proof.unpublished": "Took proof off the public site",
  "proof.reordered": "Reordered the proof wall",
  "proof.deleted": "Deleted a proof entry",
  "proof.reset": "Reset a proof entry's overrides",
  "proof.photo_added": "Added a proof photo",
  "proof.photo_removed": "Removed a proof photo",
};
